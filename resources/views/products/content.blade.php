						...
						<!--  -->
                           ...
                           <div class="p-t-33">
                            <div class="flex-w flex-r-m p-b-10">
                                <div class="size-204 flex-w flex-m respon6-next p-t-10 ">
                               
                                    <form action="/add-cart" method="post">
                                        @if ($product->price !== NULL)
                                            <div class=" flex-w m-r-20 m-tb-20 m-w-10 "> 
                                             <!--    <div class="btn-num-product-down cl8 hov-btn3 trans-04 flex-c-m" >
                                                    <i class="fs-16 zmdi zmdi-minus"></i>
                                                </div> -->
                                                <h3 class="so" style="text-align: left;">Số lượng</h3>
                                                <input class="number"id="number" type="number" name="num_product"value="1" min="1" max="3" style="border: 1px solid #b1154a;padding-left :20px; margin-left:20px;"> </br>
				...
				<div class="tab01">
					...
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item p-b-10">
							<a class="nav-link active" data-toggle="tab" href="#description" role="tab"style="color:black;font-size:30px;font-weight:bold;">Thông tin chi tiết </a>
						</li>
