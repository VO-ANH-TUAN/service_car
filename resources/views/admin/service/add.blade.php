...
{{--            <div class="form-group">--}}
{{--                <label for="menu">Video Service</label>--}}
{{--                <input type="file"  class="form-control" id="upload">--}}
{{--                <div id="image_show">--}}
{{--                    <a href="{{ old('video') }}" target="_blank">--}}
{{--                        <img src="{{ old('video') }}" width="100px">--}}
{{--                    </a>--}}
{{--                </div>--}}
{{--                <input type="hidden" name="thumb" id="thumb"value="{{ old('thumb') }}" >--}}
{{--            </div>--}}
            <div class="form-group">
                ...
                <textarea name="content" id="editor2" class="form-control">{{ old('content') }}</textarea>
                <script>
