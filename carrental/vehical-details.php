...
if($lastInsertId)
{
echo "<script>alert('Đặt xe thành công.');</script>";
echo "<script type='text/javascript'> document.location = './vnpay_php/index.php'; </script>";
...
echo "<script>alert('Đã xảy ra sự cố. Vui lòng thử lại');</script>";
 ...
 echo "<script>alert('Xe bạn chọn đã được đặt trong những ngày này');</script>";
 echo "<script type='text/javascript'> document.location = 'car-listing.php'; </script>";
}
    ...
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
          <p><?php echo '<td>' . number_format( $result->PricePerDay, 0, ',', ',') .  'VND/Ngày</td>';?></p>
      ...
      <aside class="col-md-3">
        ...
        <div class="sidebar_widget">
          ...
          <?php if($_SESSION['login'])
              {?>
              <div class="form-group">
                <input type="submit" class="btn"  name="submit" value="Thuê Ngay"><a href="./vnpay_php/index.php"></a>
              </div>
              <?php } else { ?>
