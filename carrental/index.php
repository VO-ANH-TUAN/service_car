...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      ...
      <p>Thuê một chiếc xe bạn muốn, lái đến con đường bạn mong.</p>
    </div>
    <div class="row">
...
<span class="price"><?php echo '<td>' . number_format( $result->PricePerDay, 0, ',', ',') . '</td>';?> VND/Ngày</p></span>
</div>
...
<section class="section-padding testimonial-section parallex-bg">
  <div class="container div_zindex">
    <div class="section-header white-text text-center">
      <h2>Đánh giá của<span>Khách hàng</span></h2>
    </div>
    <div class="row">
