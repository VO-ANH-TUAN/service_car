...
if($lastInsertId)
{
$msg=" Đã gửi thành công. Chúng tôi sẽ sớm liên lạc lại với bạn";
}
else
{
        ...
        <div class="contact_form gray-bg">
          <form  method="post">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control white_bg" name="message" rows="" required></textarea>
            </div>
            <div class="form-group">
        ...
        <div class="contact_detail">
          ...
          <ul>
            ...
            <li>
              ...
              <div class="contact_info_m"><a href="tel:0348252223"><?php   echo htmlentities($result->ContactNo); ?></a></div>
            </li>
            <li>
              <div class="icon_wrap"><i class="fa fa-envelope-o" aria-hidden="true"></i></div>
              <div class="contact_info_m"><a href="mailto:khachannguyen23@gmail.com"><?php   echo htmlentities($result->EmailId); ?></a></div>
            </li>
          </ul>
        <?php }} ?>
        </div>
