...
$query->execute();
$msg="Thông tin cá nhân đã được sửa thành công";
}
...
<title>T3DK | Hồ Sơ Của Tôi</title>
<!--Bootstrap -->
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Sửa Thông Tin</h5>
          <?php
         if($msg){?><div class="succWrap"><strong>Thành Công</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
          <form  method="post">
           <div class="form-group">
            ...
            <div class="form-group">
              <label class="control-label">Lần Sửa Cuối  -</label>
