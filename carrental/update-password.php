...
$error="Mật khẩu hiện tại của bạn không chính xác";
}
}
...
<title>T3Dk || Thay Đổi Mật Khẩu</title>
<!--Bootstrap -->
...
<form name="chngpwd" method="post" onSubmit="return valid();">
            ...
            <div class="form-group">
               <input type="submit" value="Thay Đổi" name="updatepass" id="submit" class="btn btn-block">
            </div>
          </form>
        </div>
      </div>
