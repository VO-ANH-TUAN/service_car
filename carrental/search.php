  ...
  <div class="container">
    <div class="page-header_wrap">
      <div class="page-heading">
        <h1>Kết Quả Của Từ Khoá "<?php echo $_POST['searchdata'];?>"</h1>
      </div>
...
$cnt=$query->rowCount();
?>
<p><span><?php echo htmlentities($cnt);?> Kết Quả</span></p>
</div>
</div>
...
{  ?>
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            ...
            <p class="list-price"><?php echo '<td>' . number_format( $result->PricePerDay, 0, ',', ',') . '</td>';?> VND/Ngày</p>
            <ul>
              <li><i class="fa fa-user" aria-hidden="true"></i><?php echo htmlentities($result->SeatingCapacity);?> Chõ Ngồi</li>
      ...
      <aside class="col-md-3 col-md-pull-9">
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-car" aria-hidden="true"></i>Xe Đã Xem</h5>
          </div>
          ...
          {  ?>
              ...
              <li class="gray-bg">
                ...
                <div class="recent_post_title"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"><?php echo htmlentities($result->BrandName);?> , <?php echo htmlentities($result->VehiclesTitle);?></a>
                  <p class="widget_price"><?php echo '<td>' . number_format( $result->PricePerDay, 0, ',', ',') . '</td>';?> VND/Ngày</p>
                </div>
              </li>
              <?php }} ?>
